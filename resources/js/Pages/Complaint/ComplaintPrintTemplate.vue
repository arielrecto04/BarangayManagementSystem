...
const incidentDate = computed(() => formatDate(props.complaint.incident_datetime))
const filingDate = computed(() => formatDate(props.complaint.filing_date))
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm print-area">
        <div class="relative bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[95vh] overflow-hidden">
            ...
            <div class="no-print flex justify-between items-center p-4 border-b">
                <h2 class="text-lg font-semibold text-gray-800">Complaint Form - Print Preview</h2>
            ...
            <div class="p-8 overflow-auto max-h-[calc(95vh-80px)] printable-content"
                    ...
                    <div class="col-span-6">
                        <div class="mb-4">
                            ...
                            <div class="border-b border-black pb-1 mb-2">
                                {{ complaint.complainant_name || '________________________' }}
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="border-b border-black pb-1">
                                {{ complaint.respondent_name || '________________________' }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-6 flex flex-col justify-start">
                        <div class="space-y-3 text-sm">
                            ...
                            <div class="flex items-baseline">
                                ...
                                <span class="border-b border-black flex-1">{{ complaint.title || '__________' }}</span>
                            </div>
                            <div class="flex items-baseline">
                                <strong class="w-40">Location of Incident:</strong>
                                <span class="border-b border-black flex-1">{{ complaint.incident_location ||
                                    '__________' }}</span>
                            </div>
                            <div class="flex items-baseline">
                                <strong class="w-40">Nature of Complaint:</strong>
                                <span class="border-b border-black flex-1">{{ complaint.nature_of_complaint ||
                                    '__________' }}</span>
                            </div>
                            <div class="flex items-baseline">
                ...
                <div class="mb-6 text-sm">
                    <div class="mb-2">
                        I/We hereby complain against above named respondent for violating my/our rights and interests in
                        the following manner:
                    </div>
                    <div class="border border-black p-3 min-h-[150px]">
                ...
                <!-- Incident Date -->
                <div class="mb-6 text-sm">
                    Occured on the <span class="border-b border-black px-2">{{ incidentDate.day }}</span> day
                    of
